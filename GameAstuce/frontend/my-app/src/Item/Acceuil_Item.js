...
function ItemAstuce({nombre, user, texte}){
    const baseUrl = "http://localhost:3000/astuces/all/approved";
                ...
                <div className="table-responsive">
                    <table className="table table-striped table-bordered">
                        ...
                        {  data.map((game,index)=>(
                                          ...
                                          <td>{"valide "}</td>   {/* cette partie ne s'affiche que s'il c'est l'utilisateur qui veux voir la liste de ses Asctuce */}
